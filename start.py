...
def initialize_bot(bot, bot_id):
    ...
    def show_command_logs(message):
        ...
        if user_id in allowed_user_ids:
            ...
            response = f"You Are Not Authorized To Use This Command.\n\nKindly Contact Admin to purchase the Access : {@PsychoVillain19}."
        bot.reply_to(message, response)
    ...
    def handle_bgmi(message):
        ...
        if user_id in allowed_user_ids or user_id in allowed_admin_ids:
            ...
            if len(command) == 4:
                ...
                port = int(command[2])
                time = int(command[3])
                if user_id not in allowed_admin_ids and time > 600:
    ...
    def show_help(message):
        ...
        help_text = f'''😍Welcome to {DEMON MOD}, {G O K U} ({@GokuthegotBot})\n\n🤖 Available commands:\n💥 /bgmi : Method For Bgmi Servers. \n💥 /rules : Please Check Before Use !!.\n💥 /mylogs : To Check Your Recents Attacks.\n💥 /plan : Checkout Our Botnet Rates.\n\n🤖 To See Admin Commands:\n💥 /admincmd : Shows All Admin Commands.\n\n'''
